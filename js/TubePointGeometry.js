...
TubeGeometry = function( path, segments, radius, radialSegments, closed, vertexColor ) {
    ...
    // construct the mesh for the cap
    {
        ...
        for( j = 0; j < this.radialSegments-2; j++)
        {
            ...
            this.faces[ faceIdx ].vertexColors[0] = new THREE.Color(0xFFFFFF);
            this.faces[ faceIdx ].vertexColors[1] = new THREE.Color(0xFFFFFF);
            this.faces[ faceIdx ].vertexColors[2] = new THREE.Color(0xFFFFFF);
            faceIdx++;
        }
        //for the back cap
